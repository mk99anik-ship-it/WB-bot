...
WELCOME_TEXT = (
    "👋 <b>Привет! Я бот для мониторинга цен на Wildberries.</b>\n\n"
    "Я слежу за ценами на нужные тебе товары и сообщаю, когда цена падает.\n\n"
    "<b>Возможности:</b>\n"
...
HELP_TEXT = (
    ...
    "2️⃣ Отправь ссылку на товар WB или его артикул\n"
    "   Пример: <code>https://www.wildberries.ru/catalog/123456789/detail.aspx</code>\n"
    "   или просто: <code>123456789</code>\n\n"
